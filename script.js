...
let tasks = [
  ...
  {
    id: 2,
    task: "Complete DAA DA",
    category: "DAs and Quizez",
    completed: false,
  },
  {
    id: 3,
    task: "Completer TOC DA",
    category: "DAs and Quizez",
    completed: false,
  },
  {
  ...
  if (categoryTasks.length === 0) {
    ...
    categoryTasks.forEach((task) => {
      ...
      checkbox.addEventListener("change", () => {
        ...
        saveLocal();
        updateTotals(); // Add this line to update totals after task completion
      });
      div.innerHTML = `
      <div class="delete">
                <svg
      ...
      deleteBtn.addEventListener("click", () => {
        ...
        saveLocal();
        renderTasks();
        updateTotals(); // Add this line to update totals after task deletion
      });
    });
  }
};
...
const addTask = (e) => {
  ...
  if (task === "") {
    ...
    toggleAddTaskForm();
    renderTasks();
    updateTotals(); // Add this line to update totals after adding a task
  }
};
...
updateTotals(); // Add this line to correctly display the total tasks initially
